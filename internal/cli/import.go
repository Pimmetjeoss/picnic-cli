...
but do not stop the import.`,
  ...
  picnic-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  picnic-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | picnic-pp-cli import <resource> --input -`,
