...
large datasets as it has no memory pressure.`,
  ...
  picnic-pp-cli export <resource> --format jsonl --output data.jsonl

  # Export with limit
  picnic-pp-cli export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  picnic-pp-cli export <resource> --format jsonl | jq '.id'`,
