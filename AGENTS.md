# Picnic Printed CLI Agent Guide

This directory is a generated `picnic-pp-cli` printed CLI. It was produced by [CLI Printing Press](https://github.com/mvanhorn/cli-printing-press), so treat systemic fixes as upstream Printing Press fixes first. Keep local edits narrow and document why a generated-tree patch belongs here.
...
picnic-pp-cli agent-context --pretty
```

Use runtime discovery instead of relying on a copied command list:

```bash
picnic-pp-cli which "<capability>" --json
picnic-pp-cli <command> --help
```
...
```bash
picnic-pp-cli <command> --help
picnic-pp-cli <command> --dry-run --agent
```
